...
const DetailVeneziaScreen : React.FC = () => {
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <ImageBackground
          source={require('../../assets/image/nice.png')}
        ...
        >
          ...
          <View style={styles.headerOverlay}>
            ...
            <Text style={styles.title}>Venezia</Text>
            <Text style={styles.subtitle}>
              From crystal-clear waters to breathtaking sunsets, Venezia is calling!
      ...
      <View style={styles.container}>
        <View style={styles.countryRow}>
          <View style={styles.flagCircle}>
            <Image source={require('../../assets/image/italia.png')} style={styles.flagImage} />
          </View>
          <Text style={styles.countryText}>Italia</Text>
        </View>

        <Text style={styles.sectionTitle}>Discover the Beauty of Venezia</Text>
...
export default DetailVeneziaScreen;